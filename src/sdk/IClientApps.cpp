...
{
	static const int idx = VFTIndexes::IClientApps::GetAppDataSection();
...
{
	static const int idx = VFTIndexes::IClientApps::RequestAppInfoUpdate();
...
{
	static const int idx = VFTIndexes::IClientApps::GetAppType();
